...
const steps = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1758519288548-046187014c85?w=800&h=600&fit=crop&auto=format",
    alt: "Nigerian software engineers collaborating on laptop in modern workspace",
